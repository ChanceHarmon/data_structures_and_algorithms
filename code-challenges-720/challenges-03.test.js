...
const sortByPrice = (arr) => arr.sort((a, b) => parseInt(a.price) - parseInt(b.price))
...
const sortPeopleBetter = (arr) => {
  return arr.sort((a, b) => {
    if (a.lastName !== b.lastName) {
      return a.lastname > b.lasteName ? 1 : -1;
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a, b) => dayOrderForSort[a.dayOfWeek] - dayOrderForSort[b.dayOfWeek])
};
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a, b) => dayOrderForSort[a.dayOfWeek] - dayOrderForSort[b.dayOfWeek] || (a.start > b.start ? 1 : (a.start < b.start ? -1 : 0)) || (a.end > b.end ? 1 : (a.end < b.end ? -1 : 0)))
};
