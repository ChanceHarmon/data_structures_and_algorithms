...
const fizzbuzz = (arr) => {
  ...
  //   if (arr[i] % 3 === 0 && arr[i] % 5 === 0) fizzIsOld.push('Fizz Buzz')
  //   else if (arr[i] % 5 === 0) fizzIsOld.push('Buzz')
  //   else if (arr[i] % 3 === 0) fizzIsOld.push('Fizz')
  //   else fizzIsOld.push(arr[i])
  // }
  arr.forEach(fb => {
    if (fb % 3 === 0 && fb % 5 === 0) fizzIsOld.push('Fizz Buzz')
    else if (fb % 5 === 0) fizzIsOld.push('Buzz')
    else if (fb % 3 === 0) fizzIsOld.push('Fizz')
    else fizzIsOld.push(fb)
  })
  return fizzIsOld
};
