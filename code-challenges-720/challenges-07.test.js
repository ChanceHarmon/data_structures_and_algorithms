...
//   let tempObj = {};
//   tempObj.name = value.stat.name;
//   tempObj.total = value.effort + value.baseStat;
//   return tempObj;
// })
//const extractStats = (arr) => arr.map(value =>  name: value.stat.name total: value.effort + value.baseStat)
